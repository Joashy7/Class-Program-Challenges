...
int main() {
  string plnText, textKey, menuInt; // String Variables 
  bool conType; // Type of Cipher Type (True = Encryption, False = Decryption)
  ...
  do{
    ...
    // Switch Case for type of Cipher
    switch(menuInt[0]){
      case '1':
        conType = true;
        userInp(plnText, textKey, conType);

        // Display Input and Result (with encryption call)
      ...
      case '2':
        ...
        // Display Input and Result (with decryption call)
        cout << "Original Plaintext: " << plnText << endl;
